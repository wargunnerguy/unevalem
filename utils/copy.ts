...
export const calculator = {
  ...
  //
  // What did NOT move: option `value` strings and each question's `answerKey`.
...
export const shop = {
  ...
  lookup: {
    metaTitle: 'Tellimuse staatus | Unevalem',
    heading: 'Tellimuse staatus',
    intro: 'Sisesta tellimuse number (leiad kinnituskirjast) ja e-post, millega tellisid.',
    numberLabel: 'Tellimuse number',
    emailLabel: 'E-post',
...
export const disclosure = {
  short: 'Osa soovitatud toodetest müüb Unevalem ise, osa viib välistesse poodidesse. Soovitused põhinevad sinu vastustel.',
  linkLabel: 'Loe, kuidas Unevalem töötab →',
